...
const BottomNav = () => {
  ...
  const activeLinkClass = "text-blue-600 dark:text-primary"; // Adjusted for dark mode
  const inactiveLinkClass = "text-gray-500 dark:text-muted-foreground"; // Adjusted for dark mode
