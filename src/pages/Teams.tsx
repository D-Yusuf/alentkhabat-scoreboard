...
const Teams = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="grid grid-cols-2 gap-4">
        {teams.map((team, index) => (
          <div key={index} className="space-y-2">
            ...
            />
            <Button onClick={() => handleAddScore(index)} className="w-full bg-primary/10 hover:bg-primary/20 text-white border-primary/30 border border-gray-300">
      ...
      <Card className="bg-card text-card-foreground mt-4 flex-grow flex flex-col overflow-hidden">
