...
const Teams = () => {
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        {teams.map((team, index) => (
          <div key={index} className="space-y-2">
            <Input
              ...
              className="text-center font-bold bg-card text-card-foreground border-primary"
            />
            <Input
              type="number"
              ...
              className="text-center bg-card text-card-foreground border-primary"
            />
      ...
      <Card className="bg-card text-card-foreground mt-4 flex-grow flex flex-col overflow-hidden border-primary">
